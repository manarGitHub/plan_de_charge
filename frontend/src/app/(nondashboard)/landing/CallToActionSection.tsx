...
const CallToActionSection = () => {
  return (
    <div className="relative py-24">
      <Image
        src="/landing-call-to-action.jpeg"
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0 md:mr-10">
            ...
            Capgemini, c’est plus de 350 000 collaborateurs unis par une même passion : l’innovation au service de la performance.            </h2>
          </div>
          <div>
            <p className="text-white mb-3">
            Optimisez vos ressources avec Capgemini, où l'excellence opérationnelle rencontre l'innovation technologique .      </p>
